...
class AppLineChartComponent extends StatefulWidget {
  ...
  @override
  State<AppLineChartComponent> createState() => _AppLineChartComponentState();
}

class _AppLineChartComponentState extends State<AppLineChartComponent> {
