...
import 'package:weatherapp_ui/components/chat/app_chat_message_component.dart';
...
class AppChatErrorMessageComponent extends StatelessWidget {
  ...
  const AppChatErrorMessageComponent({super.key, required this.width, this.onRestart});
