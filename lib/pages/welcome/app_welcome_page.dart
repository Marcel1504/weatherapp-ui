...
class AppWelcomePage extends StatelessWidget {
  ...
  Widget _header(BuildContext context) {
    return Text(
      ...
      style: Theme.of(context).textTheme.headlineLarge!.copyWith(
          color: Theme.of(context).colorScheme.secondary, fontSize: AppLayoutConfig.textWelcomeHeaderFontSize),
    );
  }

  Widget _button(BuildContext context, AppConfigurationService service) {
    return Padding(
  ...
  ListTile _tile(BuildContext context, String title, IconData? icon) {
    return ListTile(
      ...
      title: Text(
        title,
        style: Theme.of(context).textTheme.bodyMedium!.copyWith(fontSize: AppLayoutConfig.textWelcomeItemFontSize),
      ),
    );
  }
