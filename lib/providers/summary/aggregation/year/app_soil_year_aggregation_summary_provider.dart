...
import 'package:weatherapp_ui/services/backend/summary/aggregation/year/app_soil_year_aggregation_summary_backend_service.dart';
...
class AppSoilYearAggregationSummaryProvider extends AppAggregationSummaryProvider<
  ...
  AppAggregationSummaryBackendService<AppSoilAggregationSummaryListResponseDto, AppSoilFilterModel>
      getBackendService() {
    return AppSoilYearAggregationSummaryBackendService();
  }
