...
class AppVentilationResponseDto {
  AppVentilationResponseDto(
      this.absoluteHumidityOut, this.absoluteHumidityIn, this.indicator);

  double? absoluteHumidityOut;
  double? absoluteHumidityIn;
  AppVentilationIndicatorEnum? indicator;

  factory AppVentilationResponseDto.fromJson(Map<String, dynamic> json) =>
      _$AppVentilationResponseDtoFromJson(json);
